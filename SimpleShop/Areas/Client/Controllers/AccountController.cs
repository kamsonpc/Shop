...
namespace SimpleShop.Areas.Client.Controllers
{
	...
	public partial class AccountController : BaseController
	{
		...
		public virtual ActionResult Address()
		{
			...
			var address = _unitOfWork.UserAddress.Find(ua => ua.ApplicationUserId == userId).SingleOrDefault();
			return View(address);
		}
		...
		{
			var userId = User.Identity.GetUserId();
			var address = _unitOfWork.UserAddress.Find(ua => ua.ApplicationUserId == userId).SingleOrDefault().MapTo<UserAddressVM>();
		...
		public virtual ActionResult SetAddress(UserAddressVM userAddressVm)
		{
			...
			if (!ModelState.IsValid) return View(userAddressVm);
			var userAddress = userAddressVm.MapTo<UserAddress>();
		...
		[AllowAnonymous]
		public virtual ActionResult AuthorizationError()
		{
