...
using SimpleShop.Views.Shared.Alerts;
...
namespace SimpleShop.Controllers
{
	...
	public class AccountController : BaseController
	{
		...
		public ActionResult SetAddress()
		{
			var userId = User.Identity.GetUserId();
			var address = _unitOfWork.UserAddress.Find(ua => ua.ApplicationUserId == userId).SingleOrDefault();
			if (address != null) return View(Mapper.Map<UserAddress, UserAddressVM>(address));
			return View();
		}

		[HttpPost]
		[ValidateAntiForgeryToken]
		public ActionResult SetAddress(UserAddressVM userAddressVm)
		{
