...
namespace SimpleShop.Controllers
{
    public partial class CategoriesController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Categories/Create.cshtml";
            public readonly string Delete = "~/Views/Categories/Delete.cshtml";
            public readonly string Edit = "~/Views/Categories/Edit.cshtml";
            public readonly string Index = "~/Views/Categories/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CategoriesController : SimpleShop.Controllers.CategoriesController
    {
        ...
        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(SimpleShop.Models.Category category, int? id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "category", category);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
