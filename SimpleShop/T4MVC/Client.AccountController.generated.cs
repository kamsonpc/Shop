...
namespace SimpleShop.Areas.Client.Controllers
{
    public partial class AccountController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AccountController Actions { get { return MVC.Client.Account; } }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : SimpleShop.Areas.Client.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void SetAddressOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, SimpleShop.Areas.Client.Models.UsersAddress.UserAddressVM userAddressVm);

        [NonAction]
        public override System.Web.Mvc.ActionResult SetAddress(SimpleShop.Areas.Client.Models.UsersAddress.UserAddressVM userAddressVm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.SetAddress);
