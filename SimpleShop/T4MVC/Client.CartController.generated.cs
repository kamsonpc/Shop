...
namespace SimpleShop.Areas.Client.Controllers
{
    public partial class CartController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CartController Actions { get { return MVC.Client.Cart; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Complete = "~/Areas/Client/Views/Cart/Complete.cshtml";
            public readonly string Index = "~/Areas/Client/Views/Cart/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CartController : SimpleShop.Areas.Client.Controllers.CartController
    {
        ...
        [NonAction]
        partial void CompleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, SimpleShop.Areas.Client.Models.Orders.ShippingVM shippingData);

        [NonAction]
        public override System.Web.Mvc.ActionResult Complete(SimpleShop.Areas.Client.Models.Orders.ShippingVM shippingData)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Complete);
